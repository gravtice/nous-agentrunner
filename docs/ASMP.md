...
TypeScript 集成可参考：`sdk/typescript/nous-agent-runner-sdk/src/context.ts`
...
```json
{"ref":"docker.io/gravtice/nous-claude-agent-service:0.2.10"}
```
...
```json
{"images":["docker.io/gravtice/nous-claude-agent-service:0.2.10","local/xxx:tag"]}
```
...
{
  "type": "claude",
  "image_ref": "docker.io/gravtice/nous-claude-agent-service:0.2.10",

...
- 控制面协议命名：ASMP（Agent Service Management Protocol）
- 数据面协议命名：ASP（Agent Service Protocol）
- ASMP 协议文档：`docs/v0.1.0/ASMP.md`
- ASP 协议文档：`docs/v0.1.0/ASP.md`
- 设计与实现计划：`docs/v0.1.0/IMPLEMENTATION_PLAN.md`
- 构建与打包：`docs/v0.1.0/BUILDING.md`

代码结构（v1）：

- `cmd/nous-agent-runnerd`：Host daemon（ASMP + ASP 网关；子进程集成 Lima）
